	...
	return (
		<div className="char__info">
			<div className="char__basics">
				...
				<div>
					...
					<div className="char__btns">
						<a href="#1" className="button button__main">
							<div className="inner">homepage</div>
						</a>
						<a href="#1" className="button button__secondary">
			...
			<div className="char__descr">
				In Norse mythology, Loki is a god or jötunn (or both). Loki is the son of Fárbauti
				and Laufey, and the brother of Helblindi and Býleistr. By the jötunn Angrboða, Loki
				is the father of Hel, the wolf Fenrir, and the world serpent Jörmungandr. By Sigyn,
				Loki is the father of Nari and/or Narfi and with the stallion Svaðilfari as the
				father, Loki gave birth—in the form of a mare—to the eight-legged horse Sleipnir. In
